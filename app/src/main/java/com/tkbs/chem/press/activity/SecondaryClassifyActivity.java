...
import com.tkbs.chem.press.fragment.SecondaryClassifyFragment;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_classification:
                startActivityForResult(new Intent(SecondaryClassifyActivity.this, SearchClassifyActivity.class), 0);
                break;
            case R.id.img_serache:
                startActivity(new Intent(SecondaryClassifyActivity.this, SearchActivity.class));
                break;
            default:
                break;
        }
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case 0:
                    ...
                    Logger.e(result);
                    Intent intent = new Intent(SecondaryClassifyActivity.this, SearchActivity.class);
