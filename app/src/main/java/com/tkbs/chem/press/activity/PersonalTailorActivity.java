...
public class PersonalTailorActivity extends BaseActivity implements View.OnClickListener, ReWebChomeClient.OpenFileChooserCallBack {
    ...
    private String baseUrl = Config.API_SERVER + "hello/my_customization.html";
    ...
    protected void initTitle() {
        title.setText(R.string.personal_custom);
    }
    ...
    private void initWeb() {
        ...
        webView.addJavascriptInterface(new PersonalTailorInterface(), "TKBS");
        /*****************************************************************
    ...
    private class PersonalTailorInterface {

        PersonalTailorInterface() {
        }
        ...
        public String getUser() {
            String user = preference.getString("login_name", "") +
                    "," +
                    preference.getString("PASSWORD", "") + "," + UiUtils.getid(PersonalTailorActivity.this);
